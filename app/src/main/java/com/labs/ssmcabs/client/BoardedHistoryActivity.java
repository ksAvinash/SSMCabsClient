...
public class BoardedHistoryActivity extends AppCompatActivity {
    ...
    private void initializeViews(){
        ...
        boardRef = database.getReference("boarding_data/user_board_logs/"+ SharedPreferenceHelper.fetchCompanyCode(BoardedHistoryActivity.this)+"/user_logs/"+SharedPreferenceHelper.fetchUserPhoneNumber(BoardedHistoryActivity.this)
